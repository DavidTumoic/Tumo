...
function fireЕxtinguisher() {
  ...
  audio.play();
  setTimeout(() => {
    generatorEat(10, 5, size, fireEx, fireExArr);
  }, 300);
}
...
function pred() {
  ...
  audio.play();
  setTimeout(() => {
    generatorEat(5, 4, size, GrassEaterEater, grassEatEatArr);
  }, 1000);
  setTimeout(() => {
    audio.pause();
  }, 5000);
...
function grass() {
  var audio = new Audio(
    "./sound/Footsteps-in-grass-moderate-A-www.fesliyanstudios.com.ogg"
  );
  audio.play();
  setTimeout(() => {
    generatorEat(100, 1, size, Grass, grassArr);
  }, 1000);
...
function herb() {
  ...
  audio.play();
  setTimeout(() => {
    generatorEat(15, 2, size, GrassEater, grassEatArr);
  }, 1000);
}
...
function restart() {
  ...
  audio.play();
  setTimeout(() => {
    window.location.replace("./index.html?action=restart");
  }, 3000);
}
function stop() {
  var audio = new Audio("./sound/cinema-drum-hit-SBA-300419703-preview.ogg");
...
function download(filename, text, isarr) {
  ...
  element.setAttribute(
    "href",
    "data:text/plain;charset=utf-8," + encodeURIComponent(filein)
  );
